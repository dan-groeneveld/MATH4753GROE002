...
#' @param a the value to which you want to calculate the probability from negative infinity
#'
#' @return returns a plot with shaded area and prints out the probability
#' @export
#'
#' @examples
