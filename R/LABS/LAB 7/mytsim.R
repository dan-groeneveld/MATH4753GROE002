...
windows()
myTsim(n1 = 10, simga1 = 4, mean1 = 10, iter =1000, ymax = 0.45)
myTsim(n1 = 20, simga1 = 4, mean1 = 10, iter =1000, ymax = 0.45)
myTsim(n1 = 100, simga1 = 4, mean1 = 10, iter =1000, ymax = 0.45)
myTsim(n1 = 200, simga1 = 4, mean1 = 10, iter =1000, ymax = 0.45)

T = myTsim(n1 = 10, simga1 = 10, mean1 = 20, iter =1500)
hist(T$w)
