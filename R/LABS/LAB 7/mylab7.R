mychisim<-function(n1=10,sigma1=3,mean1=5,iter=1000,ymax=0.1,...){    # adjust ymax to make graph fit
  ...
  legend(locater(1),c("Simulated","Theoretical"),col=c("Blue","Red"),lwd=4,lty=1:2,bty="n",title=title) # Legend #
  return(list(w=w,summary=summary(w),sd=sd(w),fun="Chi-sq")) # some output to use if needed
}
windows()
plot1 = mychisim(n1 = 10, simga1 = 4, mean1 = 10, iter =1000)
plot2 = mychisim(n1 = 20, simga1 = 4, mean1 = 10, iter =1000)
plot3 = mychisim(n1 = 100, simga1 = 4, mean1 = 10, iter =1000)
plot4 = mychisim(n1 = 200, simga1 = 4, mean1 = 10, iter =1000)
...
#mychisim2(n1=50,n2=50,mean1=5,mean2=10,sigma1=4,sigma2=4, iter = 10000, ymax =0.04)
#mychisim2(n1=80,n2=50,mean1=3,mean2=5,sigma1=10,sigma2=10, iter = 10000, ymax =0.04)
...
#myFsim2(n1=50,n2=50,mean1=5,mean2=10,sigma1=4,sigma2=4, iter = 10000, ymax =1.5)
