...
#'
#' @param x1 data sample 1
#' @param x2 data sample 2
#' @param conf.level desired level of confidence
#' @param iter number of intervals
#' @param mudiff difference in means (mux1 - mux2)
#' @param test indicates two population t-test
#'
#' @return the p-value and a histogram of t-statistics
#' @export
#'
#' @examples myboot2pval(x1 =x, x2 = y, mudiff = 3)
#'
